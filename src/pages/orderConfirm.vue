                ...
                <div class="order-box">
                    <div class="item-address">
                        ...
                        <div class="addr-list clearfix">
                            <div class="addr-info">
                                <h2>Admin</h2>
                                <div class="phone">18600000000000</div>
                                <div class="street">北京市海淀区百度科技园</div>
                                <div class="action">
                    ...
                    <div class="item-good">
                        ...
                        <ul>
                            <li>
                                <div class="good-name">
                                    <img src="" alt="">
                                    <span>小米CC9 3200万+4800万 前后双旗舰相机</span>
                                </div>
                                <div class="good-price">1299元x1</div>
                                <div class="good-total">1299元</div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="detail">
                        ...
                        <div class="item">
                            ...
                            <span class="item-val">1299元</span>
                        </div>
                        <div class="item">
